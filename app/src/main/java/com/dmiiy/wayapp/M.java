...
import com.dmiiy.wayapp.databinding.ActivityMBinding;
import com.google.android.gms.tasks.OnSuccessListener;
import com.google.android.gms.tasks.Task;

public class M extends FragmentActivity implements OnMapReadyCallback {
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(@NonNull @org.jetbrains.annotations.NotNull Location location) {
              if (location != null){
                  ...
                  SupportMapFragment mapFragment =(SupportMapFragment) getSupportFragmentManager()
                          .findFragmentById(R.id.map);
                  mapFragment.getMapAsync(M.this);
              }
            }
        });
